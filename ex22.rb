...
readline #Reads the line and moves to next line
truncate #Empty the file
write('stuff') #Writes and appends 'stuff' to the file and close the file afterward
seek(n) # Rewinds into the file to the the 'nth' character
"def" # starts a function definition
"end" # close a function definition
